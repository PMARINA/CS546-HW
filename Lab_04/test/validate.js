...
describe('Validation Functions', function() {
    describe('Check Type', function() {
        ...
        it("Works for multiple parameters in the array", function() {
            expect(function() {
                validate.checkType('Test parameter', 'stringparam', ['string', 'number']);
        ...
        it("Throws for invalid multi-input", function() {
            expect(function() {
                validate.checkType('Test parameter', true, ['string', 'symbol', 'object']);
            }).to.throw(/^Test parameter.*?$/);
        });
        it("Throws for undefined", function() {
            expect(function() {
                validate.checkType('Test parameter', undefined, ['string', 'symbol', 'object']);
            }).to.throw(/^Test parameter.*?$/);
        });
    })
...
throw Error("Not Implemented - service options, id")
